...
export default function LightningText({
  ...
  return (
    <>
      ...
      />
      <div
        className={`pointer-events-none absolute inset-x-0 flex justify-center px-4 transition-all duration-500 ease-out ${mobile ? 'top-[28%]' : 'top-[14%]'} ${showText ? 'opacity-100 scale-100' : 'opacity-0 scale-[0.92]'}`}
        style={{ zIndex: 25 }}
      >
        <h1
